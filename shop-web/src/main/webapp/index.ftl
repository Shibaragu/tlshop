...
<#import "/index_productList_miaosha.ftl" as indexProductMiaosha/>
<@html.htmlBase>
...
<!-- 							<div style="border:1px solid red;"></div> -->
				...
				<@indexProductMiaosha.indexProductMiaosha queryType="miaosha" productList=systemManager().miaoshaProducts title="秒杀商品" />
