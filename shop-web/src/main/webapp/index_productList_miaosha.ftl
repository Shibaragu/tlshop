...
<!-- 首页不同商品的展示 -->
<#macro indexProductMiaosha queryType productList title>
			...
			<div class="col-xs-3" style="padding: 5px;text-align: center;">
				<div class="thumbnail" style="width: 100%; display: block;margin-bottom: 10px;">
					<div style="height: 200px;border: 0px solid;">
						<a href="${basepath}/product/miaosha/${item.id}.html" target="_blank">
					...
					<div style="height: 40px;">
						<div class="col-xs-12 left_product">
							<div class="row">
								<a style="cursor: pointer;" href="${basepath}/product/miaosha/${item.id}.html" target="_blank"
								title="${item.name!""}">
									${item.name!""}
								</a>
							</div>
