...
*/
     ...
     * @return
     */
    public List<Product> getMiaoshaProducts() {
    	return getCacheObject("miaoshaProducts");
    }
    
    public void setMiaoshaProducts(List<Product> saleProducts) {
    	putCacheObject("miaoshaProducts", (Serializable)(saleProducts));
    }
